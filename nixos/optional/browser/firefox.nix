{ pkgs, ... }:
{
  ...
  programs.firefox = {
    ...
    policies = {
      ...
      OverrideFirstRunPage = ""; # Override the first run page. If the value is an empty string (“”), the first run page is not displayed.
      OverridePostUpdatePage = ""; # Override the upgrade page. If the value is an empty string (“”), no extra pages are displayed when Firefox is upgraded.
